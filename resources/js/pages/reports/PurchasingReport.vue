    ...
    <div class="app-container">
      ...
      <div class="p-mt-2">
        ...
        >
          ...
          <Column header="Select to Convert to" style="width: 17rem" field="customerName">
            <template #body="slotProps">

            <input type="checkbox" name ="pl" :id="slotProps.data.receiptNo" >
          ...
          <Button
                ...
                @click="onRowSelect(slotProps.data.receiptNo)"
              />
              </template>
           </Column>
          <Column header="Supplier Name" style="width: 17rem" field="customerName">
            <template #body="slotProps">
              {{ slotProps.data.customerName }} ({{ slotProps.data.customerContact }})
            </template>
          </Column>
          <Column header="Date" field="receiptDate" style="width:10rem" >
            <template #body="slotProps">
              {{ formatDate(slotProps.data.receiptDate) }}
            </template>
          </Column>
          <Column field="receiptNo" header="Receipt No" style="width:10rem" ></Column>
          <Column field="billNo" header="Bill No" style="width:10rem" ></Column>
          ...
          <Column  header="Free Qty" field="freeUnit">
            <template #body="slotProps">
              {{ slotProps.data.freeUnit }}x
            </template>
          </Column>
          <Column  header="Sup Bonus" field="supplierBonus">
            <template #body="slotProps">
          ...
          <!-- <Column :header="'Purchase Price (' +currency+')'" field="purchasePrice">
             <template #body="slotProps">
              {{ formatAmount(slotProps.data.purchasePrice) }}
            </template>
          </Column>
          <Column header="Purchase Disc" field="purchaseDisc">
             <template #body="slotProps">
          ...
          <!-- <Column header="Cus Disc" field="itemDisc">
             <template #body="slotProps">
         ...
         <!-- <Column header="Product Type" field="productType" style="width:10rem" >
             <template #body="slotProps">
             {{ slotProps.data.productType.type }}
            </template>
          </Column> -->
          ...
          <Column :header="'Subtotal (' +currency+')'" field="subTotal" style="width:10rem" >
             <template #body="slotProps">
              {{ formatAmount(slotProps.data.totalBill) }}
            </template>
          </Column>
        </DataTable>
      </div>
        ...
        <div class="p-grid">
          ...
          <!-- <div class="p-col">
            <div class="p-field">
                ...
                <input type="text" id="categoryName"  v-model="searchFilters.vendorName" class="form-control">
...
export default class PurchasingReport extends mixins(UtilityOptions) {
  ...
  onRowSelect(rn){
    //alert('row selected' +rn);
    router.replace({ path: "/purchasing", query: {rn} });
  ...
  loadList() {
   // alert("load list");
    this.loading = true;
    //alert("report filter "+this.searchFilters);
