    ...
    <div class="app-container">
      ...
      >
        ...
        <div class="p-field">
          ...
          >
            <Column header="ACCOUNT NAME" style="width: 55%">
              <template #body="slotProps">
                <AutoComplete
                  :delay="1000"
                  :minLength="3"
            ...
            <Column :header="'DEBIT '+'('+currency+')'" style="width: 20%">
              <template #body="slotProps">
                <InputNumber
                  mode="decimal"
                  :maxFractionDigits="2"
            ...
            <Column  :header="'CREDIT '+'('+currency+')'" style="width: 20%">
              <template #body="slotProps">
                <InputNumber
                  mode="decimal"
                  :maxFractionDigits="2"
        ...
        <template #footer>
          <div class="p-grid">
            <div class="p-col-8 p-text-left">
              ...
              <Button
                type="button"
                :label="'Total Debit : ' +currency+' '+ fixDigits(totalDebitAmount)"
                class="p-button-warning"
              />
              <Button
                type="button"
                :label="'Total Credit : ' +currency+' '+ fixDigits(totalCreditAmount)"
                class="p-button-warning"
              />
              <Button
                type="button"
                :label="'Difference : '+currency+' '+  fixDigits(getTheTotalDiff)"
                class="p-button-warning"
              />
            </div>
...
export default class JournalVoucher extends Vue {
  ...
  private items = [
    ...
    { label: "Journal Vouchers", to: "journal-voucher" },
  ];
